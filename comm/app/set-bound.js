...
function setUpper(value) {
    return __awaiter(this, void 0, void 0, function* () {
        yield program.rpc.setUpperBound(value, { accounts: { dataAccount: dataAccount, adminAuth: provider.wallet.publicKey } });
...
function setLower(value) {
    return __awaiter(this, void 0, void 0, function* () {
        yield program.rpc.setLowerBound(value, { accounts: { dataAccount: dataAccount, adminAuth: provider.wallet.publicKey } });
        let stateData = yield program.account.stateData.fetch(dataAccount);
